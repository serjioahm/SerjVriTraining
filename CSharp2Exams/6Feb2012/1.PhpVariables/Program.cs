...
namespace _1.PhpVariables
{
    ...
    {
        static bool inOneLineComment;
        static bool inMultiLineComment;
        static bool inSingleQuotedString;
        static bool inDoubleQuotedString;
        static bool inVariable;
        static List<string> variables = new List<string>();

        static void Main()
        {
            PhpVariables p = new PhpVariables();
            p.ExtractVariables(p.ReadInput());
            p.PrintResult();
        }
        ...
        public void ExtractVariables(string input)
        {
